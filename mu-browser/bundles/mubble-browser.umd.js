(function (global, factory) {
    ...
    var MuUtility = /** @class */ (function () {
        ...
        MuUtility.prototype.createNavUrl = function (url, object) {
            ...
            try {
                for (var _b = tslib.__values(Object.keys(urlObj)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var key = _c.value;
                    if (key in object) {
    ...
    var PerformanceMetrics = /** @class */ (function () {
        ...
        PerformanceMetrics.prototype.finish = function () {
            ...
            try {
                for (var marks_1 = tslib.__values(marks), marks_1_1 = marks_1.next(); !marks_1_1.done; marks_1_1 = marks_1.next()) {
    ...
    var InitConfigBrowser = /** @class */ (function (_super) {
        tslib.__extends(InitConfigBrowser, _super);
        /**
         * @param {?} runMode
         * @param {?} logLevel
         * @param {?=} tzMin
    ...
    var RunStateBrowser = /** @class */ (function (_super) {
        tslib.__extends(RunStateBrowser, _super);
    ...
    var RCBrowserLogger = /** @class */ (function (_super) {
        tslib.__extends(RCBrowserLogger, _super);
        /**
         * @param {?} rc
         */
    ...
    var RunContextBrowser = /** @class */ (function (_super) {
        tslib.__extends(RunContextBrowser, _super);
    ...
    var Nail = /** @class */ (function () {
        ...
        Nail.prototype.onRunAnimation = function () {
            ...
            if (session.ignore || session.animSessionId !== session.id)
                return;
            (_a = session.ifNail).onPanAnimate.apply(_a, tslib.__spread(session.animateParam));
        };
        /**
         * @return {?}
         */
        Nail.prototype.destroy = function () {
            var e_1, _a;
            try {
                for (var _b = tslib.__values(this.handlers), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    var AlertDialogComponent = /** @class */ (function (_super) {
        tslib.__extends(AlertDialogComponent, _super);
        /**
         * @param {?} rc
         */
    ...
    var BottomInComponent = /** @class */ (function (_super) {
        tslib.__extends(BottomInComponent, _super);
        /**
         * @param {?} rc
         * @param {?} router
         * @param {?} route
    ...
    var ModalPopupComponent = /** @class */ (function (_super) {
        tslib.__extends(ModalPopupComponent, _super);
        /**
         * @param {?} rc
         * @param {?} router
         * @param {?} route
    ...
    var TranslateService = /** @class */ (function () {
        ...
        function TranslateService(rc, _translations) {
            ...
            if (Array.isArray(this._translations)) {
                ...
                var obj = {};
                try {
                    for (var _c = tslib.__values(this._translations), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var translate = _d.value;
                        /** @type {?} */
                        var keys = Object.keys(translate);
                        try {
                            for (var keys_1 = (e_2 = void 0, tslib.__values(keys)), keys_1_1 = keys_1.next(); !keys_1_1.done; keys_1_1 = keys_1.next()) {
    ...
    var FilterComponent = /** @class */ (function () {
        ...
        FilterComponent.prototype.resetFilters = function (filterItems) {
            ...
            var this_1 = this;
            try {
                for (var filterItems_1 = tslib.__values(filterItems), filterItems_1_1 = filterItems_1.next(); !filterItems_1_1.done; filterItems_1_1 = filterItems_1.next()) {
        ...
        FilterComponent.prototype.valueChanged = function () {
            ...
            try {
                ...
                for (var _b = tslib.__values(this.filterItems), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var fItem = _c.value;
        ...
        FilterComponent.prototype.initialize = function (context) {
            ...
            if (context === CONTEXT.INIT) {
                try {
                    for (var _d = tslib.__values(this.filterItems), _e = _d.next(); !_e.done; _e = _d.next()) {
                        var fItem = _e.value;
                ...
                var fItems = [];
                try {
                    for (var _f = tslib.__values(this.filterItems), _g = _f.next(); !_g.done; _g = _f.next()) {
                        var fItem = _g.value;
                        /** @type {?} */
                ...
                var this_3 = this;
                try {
                    for (var _h = tslib.__values(this.filterItems), _j = _h.next(); !_j.done; _j = _h.next()) {
                        var fItem = _j.value;
                        _loop_3(fItem);
                    }
                }
    ...
    var NcMaxLengthDirective = /** @class */ (function () {
        ...
        NcMaxLengthDirective.prototype.ngOnDestroy = function () {
            var e_1, _a;
            try {
                for (var _b = tslib.__values(this.eventHandlers), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    var GenericPipe = /** @class */ (function () {
        ...
        GenericPipe.prototype.transform = function (value, pipeName, pipeParams) {
            ...
            if (pipe.transform && typeof pipe.transform === 'function') {
                if (pipeParams)
                    return pipe.transform.apply(pipe, tslib.__spread([value], pipeParams));
    ...
    var DropDownMultiSelectComponent = /** @class */ (function () {
        ...
        DropDownMultiSelectComponent.prototype.onHostClick = function (element) {
            ...
            if (this.showDropDown) {
                try {
                    for (var calExpStr_1 = tslib.__values(calExpStr), calExpStr_1_1 = calExpStr_1.next(); !calExpStr_1_1.done; calExpStr_1_1 = calExpStr_1.next()) {
    ...
    var InfiniteScrollComponent = /** @class */ (function () {
        ...
        InfiniteScrollComponent.prototype.cacheViewedItemsHeight = function () {
            ...
            try {
                for (var viewPortChildren_1 = tslib.__values(viewPortChildren), viewPortChildren_1_1 = viewPortChildren_1.next(); !viewPortChildren_1_1.done; viewPortChildren_1_1 = viewPortChildren_1.next()) {
    ...
    var MuFormContainerComponent = /** @class */ (function () {
        ...
        MuFormContainerComponent.prototype.onSubmit = function (manual, id) {
            ...
            try {
                for (var _c = tslib.__values(this.formParams.inputParams), _d = _c.next(); !_d.done; _d = _c.next()) {
            ...
            try {
                for (var _e = tslib.__values(this.formParams.inputParams), _f = _e.next(); !_f.done; _f = _e.next()) {
        ...
        MuFormContainerComponent.prototype.hasError = function () {
            ...
            var hasError = false;
            try {
                for (var _b = tslib.__values(this.formParams.inputParams), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    var MuDataTableComponent = /** @class */ (function () {
        ...
        MuDataTableComponent.prototype.setUpTable = function () {
            ...
            if (this.tableConfig) {
                try {
                    for (var _c = tslib.__values(this.tableConfig.headers), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var header = _d.value;
            ...
            if (this.tableConfig.stickyConfig && this.tableConfig.stickyConfig.noOfCols > 0) {
                ...
                try {
                    for (var _e = tslib.__values(this.tableConfig.headers), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var header = _f.value;
                        if (header.widthPerc) {
        ...
        MuDataTableComponent.prototype.insertRow = function (obj) {
            ...
            if (!this.tableConfig.lazyLoad) {
                ...
                var newIndexes = {};
                try {
                    for (var _b = tslib.__values(Object.keys(this.selectedIndexes)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var index = _c.value;
        ...
        MuDataTableComponent.prototype.deleteRow = function (rowIndex) {
            ...
            if (!this.tableConfig.lazyLoad) {
                ...
                var newIndexes = {};
                try {
                    for (var _c = tslib.__values(Object.keys(this.selectedIndexes)), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var index = _d.value;
                        newIndexes[Number(index) - 1] = true;
                    }
                }
        ...
        MuDataTableComponent.prototype.unselectIndexes = function (rowIndexes) {
            var e_6, _a;
            try {
                for (var rowIndexes_1 = tslib.__values(rowIndexes), rowIndexes_1_1 = rowIndexes_1.next(); !rowIndexes_1_1.done; rowIndexes_1_1 = rowIndexes_1.next()) {
    ...
    var MaskingValueDirective = /** @class */ (function (_super) {
        tslib.__extends(MaskingValueDirective, _super);
        /**
         * @param {?} element
         * @param {?} renderer
         * @param {?} ngZone
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            tsB64 = btoa(String.fromCharCode.apply(String, tslib.__spread(encTs)));
                            return [4 /*yield*/, this.encryptSymKey()];
                        case 2:
                            keyBuffer = _a.sent();
                            encKey = ( /** @type {?} */(new Uint8Array(keyBuffer)));
                            keyB64 = btoa(String.fromCharCode.apply(String, tslib.__spread(encKey)));
                        ...
                        case 3:
                            ...
                            configB64 = btoa(String.fromCharCode.apply(String, tslib.__spread(encConfig)));
                        ...
                        case 1:
                            ...
                            for (index = 0; index < temp.length; index++)
                                if (temp[index] === newLineCode)
                                    break;
                            jsonStr = String.fromCharCode.apply(String, tslib.__spread(( /** @type {?} */(temp.slice(0, index)))));
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, btoa(String.fromCharCode.apply(String, tslib.__spread(arr)))];
                    }
                });
            });
        };
    ...
    var PakoWorkerClient = /** @class */ (function () {
        ...
        PakoWorkerClient.prototype.sendMessage = function (apiName) {
            ...
            this.worker.postMessage(tslib.__spread([asyncRequest.requestId, apiName], params));
        ...
        PakoWorkerClient.prototype.onMessage = function (event) {
            var _a = tslib.__read(event.data), reqId = _a[0], resp = _a.slice(1);
            /** @type {?} */
            ...
            asyncRequest.resolve.apply(asyncRequest, tslib.__spread(resp));
        };
    ...
    var WsBrowser = /** @class */ (function () {
        ...
        WsBrowser.prototype.uiArToB64 = function (ar) {
            return btoa(String.fromCharCode.apply(String, tslib.__spread(ar)));
        };
        /**
         * @param {?} event
         * @return {?}
        ...
        WsBrowser.prototype.send = function (rc, data) {
            ...
            if (this.ephemeralEvents.length) {
                objects.push.apply(objects, tslib.__spread(this.ephemeralEvents));
    ...
    var UserKeyValue = /** @class */ (function () {
        ...
        UserKeyValue.prototype.getAllUserLinkIds = function () {
            ...
            var ids = [];
            try {
                for (var _b = tslib.__values(Object.keys(this.users)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var i = _c.value;
    ...
    var GlobalKeyValue = /** @class */ (function () {
                ...
                return tslib.__generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            ...
                            _a = tslib.__values(Object.keys(GlobalKeyValue.fieldMap)), _b = _a.next();
                            _d.label = 2;
                        case 2:
        ...
        GlobalKeyValue.prototype.detectSaveChanges = function () {
            var e_2, _a;
            try {
                for (var _b = tslib.__values(Object.keys(GlobalKeyValue.fieldMap)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var name = _c.value;
                    /** @type {?} */
    ...
    var MasterDb = /** @class */ (function (_super) {
        tslib.__extends(MasterDb, _super);
        /**
         * @param {?} rc
         * @param {?} version
         * @param {?} versionSchema
                ...
                return tslib.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            this_1 = this;
                            try {
                                for (models_1 = tslib.__values(models), models_1_1 = models_1.next(); !models_1_1.done; models_1_1 = models_1.next()) {
        ...
        MasterDb.prototype.verifySegmentVersion = function (rc, version) {
            ...
            var _a = tslib.__read(segments[Segment.version], 1), _b = tslib.__read(_a[0], 1), oldVersion = _b[0];
        ...
        MasterDb.prototype.buildSchema = function (schema) {
            ...
            try {
                for (var _b = tslib.__values(Object.keys(modelMap)), _c = _b.next(); !_c.done; _c = _b.next()) {
            ...
            return tslib.__awaiter(this, void 0, void 0, function () {
                ...
                return tslib.__generator(this, function (_d) {
                    switch (_d.label) {
                        ...
                        case 1:
                            _d.trys.push([1, 6, 7, 8]);
                            _a = tslib.__values(Object.keys(syncResponse)), _b = _a.next();
                            _d.label = 2;
                        case 2:
                            if (!!_b.done) return [3 /*break*/, 5];
                            modelName = _b.value;
                ...
                return tslib.__generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            arMod_1 = tslib.__values(arMod), arMod_1_1 = arMod_1.next();
                            _b.label = 2;
                        case 2:
                                    ...
                                    return tslib.__generator(this, function (_b) {
                                        switch (_b.label) {
                                            ...
                                            case 1:
                                                ...
                                                arDel_1 = tslib.__values(arDel), arDel_1_1 = arDel_1.next();
                                                _b.label = 2;
                                            case 2:
    ...
    var NcPlatformLocation = /** @class */ (function (_super) {
        tslib.__extends(NcPlatformLocation, _super);
        /**
         * @param {?} rc
         */
    ...
    var RoutableScreen = /** @class */ (function (_super) {
        tslib.__extends(RoutableScreen, _super);
        /**
         * @param {?} rc
         */
    ...
    var AppLocationStrategy = /** @class */ (function (_super) {
        tslib.__extends(AppLocationStrategy, _super);
        /**
         * @param {?} rc
         */
                        ...
                        case 0:
                            ...
                            switch (this.userAgent) {
                                case UserAgent.ANDROID:
                                    (_a = window['cordova'])[apiName].apply(_a, tslib.__spread([nar.requestId], params));
                                    break;
                                case UserAgent.IOS:
    ...
    var MuSdkBridge = /** @class */ (function (_super_1) {
        tslib.__extends(MuSdkBridge, _super_1);
        /**
         * @param {?} rc
         * @param {?} ngZone
         */
    ...
    var MuRouterApp = /** @class */ (function (_super_1) {
        tslib.__extends(MuRouterApp, _super_1);
        /**
         * @param {?} rc
         * @param {?} serverUrl
         * @param {?} ci
    ...
    var MuUiRouter = /** @class */ (function (_super) {
        tslib.__extends(MuUiRouter, _super);
        /**
         * @param {?} rc
         * @param {?} router
         * @param {?} translate
    ...
    var RunContextJest = /** @class */ (function (_super) {
        tslib.__extends(RunContextJest, _super);
        /**
         * @param {?} initConfig
         * @param {?} runState
         * @param {?=} contextId
