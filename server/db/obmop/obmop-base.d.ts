import { Mubble, SORT_MODE } from '@mubble/core';
import { RunContextServer } from '../../rc-server';
export declare namespace Obmop {
    enum FieldType {
        PRIMARY = 1,
        MANDATORY = 2,
        OPTIONAL = 3
     ...
     */
    function model(): (target: any) => void;
    /**
     *  Annotation to mark a obmop model field.
     *  Make sure the table name is same as the name of the class in lower case.
     */
    function field(type?: FieldType, unique?: boolean, indexed?: boolean, serial?: boolean, sequence?: string): (target: any, propertyKey: string) => void;
    /**
     *  Annotation to mark a obmop model primary key.
     *  Make sure the table name is same as the name of the class in lower case.
     */
    function primaryKey(serial?: boolean, sequence?: string): (target: any, propertyKey: string) => void;
}
/**
 *  All obmop model entities to be extended from this entity.
 *  Make sure the table name is same as the name of the class in lower case.
 */
export declare class ObmopBaseEntity {
    private _tableName;
 ...
 */
export declare type QueryRetval = {
